...
class DatabaseHelper extends SQLiteOpenHelper {
    ...
    void updateData(String row_id, String title, String author, String pages){
        ...
        if(result == -1){
            Toast.makeText(context, "GagalMesunting", Toast.LENGTH_SHORT).show();
        }else {
            Toast.makeText(context, "Berhasil Mesunting!", Toast.LENGTH_SHORT).show();
        }
